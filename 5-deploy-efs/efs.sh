...
echo $MOUNT_TARGET_GROUP_NAME
echo $MOUNT_TARGET_GROUP_DESC
...
# aws efs create-mount-target --file-system-id $FILE_SYSTEM_ID --security-groups $MOUNT_TARGET_GROUP_ID --subnet-id $subnet 
